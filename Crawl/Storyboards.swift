...
struct Storyboards {
    ...
    struct Main: Storyboard {
        ...
        static func instantiateCrawlList() -> CrawlListViewController {
            return self.storyboard.instantiateViewControllerWithIdentifier("CrawlList") as! CrawlListViewController
        }

        static func instantiateCrawlDetail() -> CrawlDetailViewController {
            return self.storyboard.instantiateViewControllerWithIdentifier("CrawlDetail") as! CrawlDetailViewController
        }

        static func instantiateRootNavigationController() -> UINavigationController {
            return self.storyboard.instantiateViewControllerWithIdentifier("RootNavigationController") as! UINavigationController
        }
    }

    struct Presentation: Storyboard {

        static let identifier = "Presentation"

        static var storyboard: UIStoryboard {
            return UIStoryboard(name: self.identifier, bundle: nil)
        }

        static func instantiateInitialViewController() -> CrawlViewController {
            return self.storyboard.instantiateInitialViewController() as! CrawlViewController
        }
...
extension UIStoryboardSegue {
    func selection() -> CrawlListViewController.Segue? {
        if let identifier = self.identifier {
            return CrawlListViewController.Segue(rawValue: identifier)
        }
        return nil
    }
}

extension CrawlListViewController: IdentifiableProtocol { 
    var storyboardIdentifier: String? { return "CrawlList" }
    static var storyboardIdentifier: String? { return "CrawlList" }
}

extension CrawlListViewController { 
...
//MARK: - CrawlDetailViewController
extension CrawlDetailViewController: IdentifiableProtocol { 
    var storyboardIdentifier: String? { return "CrawlDetail" }
    static var storyboardIdentifier: String? { return "CrawlDetail" }
}


//MARK: - CrawlViewController
